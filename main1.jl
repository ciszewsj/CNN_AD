...
do_magic_trick(x_train, y_train', x_test, y_test', 1, 1e-4, 3)
do_magic_trick(x_train, y_train', x_test, y_test', 16, 1e-2, 3)
do_magic_trick(x_train, y_train', x_test, y_test', 100, 1e-2,3)
...
do_magic_trick_2(x_train, y_train', x_test, y_test', 1, 1e-4, 3)
do_magic_trick_2(x_train, y_train', x_test, y_test', 16, 1e-3, 3)
do_magic_trick_2(x_train, y_train', x_test, y_test', 100, 1e-2, 3)